...
import 'package:productive/features/tasks/presentation/witdets/task_item.dart';
                  ...
                  return TabBarView(
                    ...
                    children: [
                      ListView.separated(
                          ...
                          itemBuilder: (_, index) {
                            return TaskItem(taskModel: state.upcomingTasks[index],);
                          },
                      ...
                      ListView.separated(
                          padding:const EdgeInsets.symmetric(
                              horizontal: 16, vertical: 20),
                          itemBuilder: (_, index) {
                            return state.allTasks.isEmpty? const Center(child: Text("Is Empty"),):TaskItem(taskModel: state.allTasks[index],);
                          },
                          separatorBuilder: (_, __) => const Gap(16),
